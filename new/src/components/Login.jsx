  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.status === "success") {
        ...
        localStorage.setItem("student", JSON.stringify(data.user)); // store user info if needed
        navigate("/payment"); // redirect to dashboard page
      } else {
      ...
      <div className="login-container">
        <div className="login-form">
          ...
          <p style={{ marginBottom: "0.5rem" }}>
            ...
            <span style={{ color: "purple" }}>TechHub</span>
          </p>
